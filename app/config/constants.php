...
// defined('LINE_TOKEN2')  OR define('LINE_TOKEN2', 'uH5MHvADqQStenQf02yNzAqTIXcTBBkQn9EpYV7ZhNs');
...
defined('WEEKDAY') OR define('WEEKDAY', ['日', '月', '火', '水', '木', '金', '土']);

defined('VIEW_PATH') OR define('VIEW_PATH', 'app/views');

defined('TXT_MAIN') OR define('TXT_MAIN', 1);
defined('TXT_SUB')  OR define('TXT_SUB',  2);

defined('ACCOUNT_LIST')  OR define('ACCOUNT_LIST',
[
	'99999999' => 'hogehoge',
]
);